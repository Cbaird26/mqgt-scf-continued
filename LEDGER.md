...
| 2026-09-18 | ChatGPT (round 5) | erratum 4's per-channel "no-cancellation" bound is not sufficient for the combined cap (0.9 C + 0.9 C = 1.8 C); three statements must be labeled separately | verified (triangle inequality), repaired: note erratum 5 + script e2 + ledger e2 row | (this commit) |
